...
and safe to delete at any time — *nothing here should be the only copy
...
*slow to rebuild/rerun, but not precious; losing either just means
Nextflow re-pulls images or re-executes processes next run.*
