...
`/proj/naiss20xx-yy-zz/nobackup/nxf-work/singularity`. The container
image and version each Singularity image was made from can be found in
...
`<cluster>` was created to utilise the `singularity` container technology
