...
redmine_id: "[TODO]"
project_contact: "[TODO]"
project_pi: "[TODO]"
compute_project: "[TODO]"
storage_project: "[TODO]"
---

* Redmine ID: {{< meta redmine_id >}}
* Request by: {{< meta project_contact >}}
* Principal Investigator: {{< meta project_pi >}}
...
```
<project_root>/                                (NAISS Compute Allocation)
 |
 | - README.md                                 Project details summary
 | - pixi.toml                                 Tools and tasks, incl. Nextflow (pixi)
 |
 | - analyses/                                 Analysis configuration files
 | - docs/                                     Project documentation
 \ - code/                                     Nextflow workflow

/proj/naiss20xx-yy-zz/                         (NAISS Storage Allocation, or data/ locally)
 |
