...
* Redmine ID: {{< var redmine_id >}}
* Request by: {{< var project_contact >}}
* Principal Investigator: {{< var project_pi >}}
...
- {{< var compute_project >}} (NAISS Compute allocation, Rackham)
- {{< var storage_project >}} (NAISS Storage allocation, Rackham)
...
`/proj/naiss20XX-YY-ZZ/NBIS_support_<id>/workflow/configs/singularity_packages.config`.
